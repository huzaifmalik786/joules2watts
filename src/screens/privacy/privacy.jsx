  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundColor: screenWidth < 1440 ? "#ffffff" : screenWidth >= 1440 ? "#f6f7f8" : undefined,
          height: screenWidth < 1440 ? "4818px" : screenWidth >= 1440 ? "3711px" : undefined,
      ...
      >
        ...
        <div
          className="overlap-3"
          style={{
            height: screenWidth >= 1440 ? "950px" : screenWidth < 1440 ? "284px" : undefined,
            left: screenWidth >= 1440 ? "0" : screenWidth < 1440 ? "81px" : undefined,
            top: screenWidth >= 1440 ? "89px" : screenWidth < 1440 ? "1035px" : undefined,
            width: screenWidth >= 1440 ? "1465px" : screenWidth < 1440 ? "228px" : undefined,
          }}
        >
          {screenWidth >= 1440 && (
            <>
          ...
          {screenWidth < 1440 && <div className="ellipse-3" />}

          <img
            className="hand-holding-cloud"
            style={{
              height: screenWidth < 1440 ? "253px" : screenWidth >= 1440 ? "473px" : undefined,
              left: screenWidth < 1440 ? "32px" : screenWidth >= 1440 ? "729px" : undefined,
              top: screenWidth < 1440 ? "31px" : screenWidth >= 1440 ? "0" : undefined,
              width: screenWidth < 1440 ? "196px" : screenWidth >= 1440 ? "736px" : undefined,
            }}
