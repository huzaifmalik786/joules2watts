  ...
  return (
    <div className="staffing">
      <div
        className="iphone"
        style={{
          height: screenWidth < 1440 ? "9833px" : screenWidth >= 1440 ? "5542px" : undefined,
      ...
      >
        ...
        <div
          className="frame-4"
          style={{
            height: screenWidth < 1440 ? "562px" : screenWidth >= 1440 ? "1243px" : undefined,
            left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "-1px" : undefined,
            top: screenWidth < 1440 ? "60px" : screenWidth >= 1440 ? "0" : undefined,
            width: screenWidth < 1440 ? "390px" : screenWidth >= 1440 ? "1442px" : undefined,
          }}
        >
          {screenWidth < 1440 && (
        ...
        <div
          className="overlap-7"
          style={{
            backgroundColor: screenWidth >= 1440 ? "#f6f7f8" : screenWidth < 1440 ? "#022c27" : undefined,
            height: screenWidth >= 1440 ? "1562px" : screenWidth < 1440 ? "1581px" : undefined,
            top: screenWidth >= 1440 ? "1244px" : screenWidth < 1440 ? "622px" : undefined,
            width: screenWidth >= 1440 ? "1449px" : screenWidth < 1440 ? "390px" : undefined,
          }}
        >
          <div
            className="frame-17"
            style={{
              height: screenWidth < 1440 ? "1242px" : screenWidth >= 1440 ? "731px" : undefined,
              left: screenWidth < 1440 ? "20px" : screenWidth >= 1440 ? "59px" : undefined,
              top: screenWidth < 1440 ? "294px" : screenWidth >= 1440 ? "73px" : undefined,
              width: screenWidth < 1440 ? "349px" : screenWidth >= 1440 ? "961px" : undefined,
            }}
          >
            <div
              className="frame-18"
              style={{
                ...
                gap: screenWidth < 1440 ? "12px" : undefined,
                height: screenWidth >= 1440 ? "731px" : undefined,
                left: screenWidth < 1440 ? "175px" : screenWidth >= 1440 ? "0" : undefined,
                top: screenWidth < 1440 ? "134px" : screenWidth >= 1440 ? "0" : undefined,
                width: screenWidth >= 1440 ? "829px" : undefined,
              }}
            >
              {screenWidth < 1440 && (
                <>
            ...
            <div
              ...
              style={{
                ...
                height: screenWidth < 1440 ? "978px" : undefined,
                justifyContent: screenWidth >= 1440 ? "center" : undefined,
                left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "749px" : undefined,
                top: screenWidth < 1440 ? "264px" : screenWidth >= 1440 ? "158px" : undefined,
                width: screenWidth < 1440 ? "349px" : undefined,
              }}
            >
              <div
                className="overlap-22"
                style={{
                  color: screenWidth >= 1440 ? "#2e5053" : undefined,
                  fontFamily: screenWidth >= 1440 ? "var(--title-mega-font-family)" : undefined,
                  fontSize: screenWidth >= 1440 ? "var(--title-mega-font-size)" : undefined,
                  fontStyle: screenWidth >= 1440 ? "var(--title-mega-font-style)" : undefined,
                  fontWeight: screenWidth >= 1440 ? "var(--title-mega-font-weight)" : undefined,
                  height: screenWidth < 1440 ? "838px" : screenWidth >= 1440 ? "48px" : undefined,
                  left: screenWidth < 1440 ? "0" : undefined,
                  letterSpacing: screenWidth >= 1440 ? "var(--title-mega-letter-spacing)" : undefined,
                  lineHeight: screenWidth >= 1440 ? "var(--title-mega-line-height)" : undefined,
                  marginTop: screenWidth >= 1440 ? "-1.00px" : undefined,
                  position: screenWidth < 1440 ? "absolute" : screenWidth >= 1440 ? "relative" : undefined,
                  textAlign: screenWidth >= 1440 ? "center" : undefined,
                  top: screenWidth < 1440 ? "140px" : undefined,
                  whiteSpace: screenWidth >= 1440 ? "nowrap" : undefined,
                  width: screenWidth < 1440 ? "349px" : screenWidth >= 1440 ? "114px" : undefined,
                }}
              >
                {screenWidth < 1440 && (
                  <>
              ...
              <div
                ...
                style={{
                  alignItems: screenWidth < 1440 ? "center" : undefined,
                  color: screenWidth >= 1440 ? "#2c3e47" : undefined,
                  display: screenWidth < 1440 ? "inline-flex" : undefined,
                  flexDirection: screenWidth < 1440 ? "column" : undefined,
                  fontFamily: screenWidth >= 1440 ? "'Source Sans Pro', Helvetica" : undefined,
                  fontSize: screenWidth >= 1440 ? "17px" : undefined,
                  fontWeight: screenWidth >= 1440 ? "600" : undefined,
                  gap: screenWidth < 1440 ? "12px" : undefined,
                  height: screenWidth >= 1440 ? "43px" : undefined,
                  left: screenWidth < 1440 ? "0" : undefined,
                  letterSpacing: screenWidth >= 1440 ? "-0.17px" : undefined,
                  lineHeight: screenWidth >= 1440 ? "23.8px" : undefined,
                  position: screenWidth < 1440 ? "absolute" : screenWidth >= 1440 ? "relative" : undefined,
                  top: screenWidth < 1440 ? "0" : undefined,
                  width: screenWidth >= 1440 ? "197px" : undefined,
                }}
              >
                {screenWidth < 1440 && (
                  <>
                ...
                {screenWidth >= 1440 && (
                  <p className="text-wrapper-90">Clients with who we have delivered bulk deals</p>
                )}
              </div>
            </div>
            <div
              ...
              style={{
                ...
                gap: screenWidth < 1440 ? "12px" : screenWidth >= 1440 ? "16px" : undefined,
                left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "754px" : undefined,
                top: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "354px" : undefined,
              }}
            >
              {screenWidth < 1440 && (
                <>
          ...
          <div
            ...
            style={{
              color: screenWidth < 1440 ? "#f6f7f8" : screenWidth >= 1440 ? "#1f1f1f" : undefined,
              fontSize: screenWidth < 1440 ? "24px" : screenWidth >= 1440 ? "42px" : undefined,
              height: screenWidth < 1440 ? "170px" : screenWidth >= 1440 ? "50px" : undefined,
              left: screenWidth < 1440 ? "41px" : screenWidth >= 1440 ? "325px" : undefined,
              letterSpacing: screenWidth < 1440 ? "-0.24px" : screenWidth >= 1440 ? "-1.05px" : undefined,
              lineHeight: screenWidth < 1440 ? "33.6px" : screenWidth >= 1440 ? "50.4px" : undefined,
              top: screenWidth < 1440 ? "67px" : screenWidth >= 1440 ? "865px" : undefined,
              width: screenWidth < 1440 ? "307px" : screenWidth >= 1440 ? "827px" : undefined,
            }}
          >
            {screenWidth < 1440 && (
            ...
            {screenWidth >= 1440 && <p className="text-wrapper-90">Who is on our team?</p>}
          </div>
          {screenWidth >= 1440 && (
            <>
        ...
        <div
          ...
          style={{
            height: screenWidth >= 1440 ? "669px" : screenWidth < 1440 ? "1727px" : undefined,
            left: screenWidth >= 1440 ? "0" : screenWidth < 1440 ? "-185px" : undefined,
            top: screenWidth >= 1440 ? "4875px" : screenWidth < 1440 ? "7246px" : undefined,
            width: screenWidth >= 1440 ? "1441px" : screenWidth < 1440 ? "742px" : undefined,
          }}
        >
          {screenWidth < 1440 && (
          ...
          <div
            className="frame-46"
            style={{
              height: screenWidth < 1440 ? "1050px" : screenWidth >= 1440 ? "380px" : undefined,
              top: screenWidth < 1440 ? "677px" : screenWidth >= 1440 ? "0" : undefined,
              width: screenWidth < 1440 ? "742px" : screenWidth >= 1440 ? "1440px" : undefined,
            }}
          >
            {screenWidth < 1440 && (
              <>
