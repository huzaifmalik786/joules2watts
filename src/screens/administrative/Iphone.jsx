  ...
  return (
    <div className="administrative">
      <div
        className="div-2"
        style={{
          height: screenWidth < 1440 ? "6033px" : screenWidth >= 1440 ? "4039px" : undefined,
      ...
      >
        ...
        <div
          className="overlap-5"
          style={{
            height: screenWidth >= 1440 ? "626px" : screenWidth < 1440 ? "2722px" : undefined,
            left: screenWidth >= 1440 ? "-3px" : screenWidth < 1440 ? "0" : undefined,
            top: screenWidth >= 1440 ? "-11px" : screenWidth < 1440 ? "605px" : undefined,
            width: screenWidth >= 1440 ? "1443px" : screenWidth < 1440 ? "393px" : undefined,
          }}
        >
          <div
            className="frame-15"
            style={{
              height: screenWidth < 1440 ? "583px" : screenWidth >= 1440 ? "532px" : undefined,
              left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "3px" : undefined,
              top: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "99px" : undefined,
              width: screenWidth < 1440 ? "390px" : screenWidth >= 1440 ? "1440px" : undefined,
            }}
          />
          {screenWidth < 1440 && (
          ...
          <img
            ...
            style={{
              height: screenWidth >= 1440 ? "536px" : screenWidth < 1440 ? "533px" : undefined,
              left: screenWidth >= 1440 ? "337px" : screenWidth < 1440 ? "0" : undefined,
              top: screenWidth >= 1440 ? "99px" : screenWidth < 1440 ? "1107px" : undefined,
              width: screenWidth >= 1440 ? "1106px" : screenWidth < 1440 ? "325px" : undefined,
            }}
            alt="Two collegues"
            src={
              screenWidth >= 1440
          ...
          <img
            ...
            style={{
              height: screenWidth >= 1440 ? "536px" : screenWidth < 1440 ? "533px" : undefined,
              left: screenWidth >= 1440 ? "3px" : screenWidth < 1440 ? "16px" : undefined,
              top: screenWidth >= 1440 ? "99px" : screenWidth < 1440 ? "408px" : undefined,
              width: screenWidth >= 1440 ? "1440px" : screenWidth < 1440 ? "374px" : undefined,
            }}
            alt="Rectangle"
            src={
              screenWidth >= 1440
          ...
          <div
            className="frame-20"
            style={{
              gap: screenWidth >= 1440 ? "42px" : screenWidth < 1440 ? "40px" : undefined,
              left: screenWidth >= 1440 ? "83px" : screenWidth < 1440 ? "23px" : undefined,
              top: screenWidth >= 1440 ? "205px" : screenWidth < 1440 ? "805px" : undefined,
            }}
          >
            {screenWidth >= 1440 && (
              <>
        ...
        <div
          className="overlap-7"
          style={{
            height: screenWidth >= 1440 ? "1100px" : screenWidth < 1440 ? "1050px" : undefined,
            left: screenWidth >= 1440 ? "-6px" : screenWidth < 1440 ? "-185px" : undefined,
            top: screenWidth >= 1440 ? "615px" : screenWidth < 1440 ? "4123px" : undefined,
            width: screenWidth >= 1440 ? "1446px" : screenWidth < 1440 ? "742px" : undefined,
          }}
        >
          {screenWidth >= 1440 && (
            <>
          ...
          <div
            className="frame-45"
            style={{
              gap: screenWidth < 1440 ? "92px" : screenWidth >= 1440 ? "16px" : undefined,
              left: screenWidth < 1440 ? "185px" : screenWidth >= 1440 ? "86px" : undefined,
              top: screenWidth < 1440 ? "366px" : screenWidth >= 1440 ? "94px" : undefined,
            }}
          >
            {screenWidth < 1440 && (
              <>
            ...
            {screenWidth >= 1440 && <div className="frame-50" />}
          </div>
          {screenWidth >= 1440 && (
            <>
