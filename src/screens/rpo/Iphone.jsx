  ...
  return (
    <div className="rpo">
      <div
        className="div-2"
        style={{
          height: screenWidth < 1440 ? "5153px" : screenWidth >= 1440 ? "3553px" : undefined,
      ...
      >
        ...
        <div
          className="overlap-4"
          style={{
            height: screenWidth >= 1440 ? "629px" : screenWidth < 1440 ? "1945px" : undefined,
            left: screenWidth >= 1440 ? "-17px" : screenWidth < 1440 ? "0" : undefined,
            top: screenWidth >= 1440 ? "2632px" : screenWidth < 1440 ? "502px" : undefined,
            width: screenWidth >= 1440 ? "1456px" : screenWidth < 1440 ? "390px" : undefined,
          }}
        >
          <div
            className="frame-12"
            style={{
              backgroundColor: screenWidth < 1440 ? "#e9e9e9" : screenWidth >= 1440 ? "#f6f7f8" : undefined,
              height: screenWidth < 1440 ? "1945px" : screenWidth >= 1440 ? "629px" : undefined,
              left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "16px" : undefined,
              width: screenWidth < 1440 ? "390px" : screenWidth >= 1440 ? "1440px" : undefined,
            }}
          >
            {screenWidth < 1440 && (
        ...
        <div
          className="overlap-8"
          style={{
            height: screenWidth >= 1440 ? "2639px" : screenWidth < 1440 ? "1050px" : undefined,
            left: screenWidth >= 1440 ? "0" : screenWidth < 1440 ? "-185px" : undefined,
            top: screenWidth >= 1440 ? "-7px" : screenWidth < 1440 ? "3243px" : undefined,
            width: screenWidth >= 1440 ? "1440px" : screenWidth < 1440 ? "742px" : undefined,
          }}
        >
          {screenWidth >= 1440 && (
            <>
              ...
              <div className="overlap-group-9">
                ...
                <div className="frame-64">
                  ...
                  <div className="frame-33">
                    ...
                    <img className="amazon-2" alt="Amazon" src="/rpo/amazon-1-1.png" />
          ...
          <div
            className="frame-65"
            style={{
              gap: screenWidth < 1440 ? "92px" : screenWidth >= 1440 ? "15px" : undefined,
              left: screenWidth < 1440 ? "185px" : screenWidth >= 1440 ? "133px" : undefined,
              top: screenWidth < 1440 ? "366px" : screenWidth >= 1440 ? "1364px" : undefined,
            }}
          >
            {screenWidth < 1440 && (
              <>
