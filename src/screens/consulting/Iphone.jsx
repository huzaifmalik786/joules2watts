  ...
  return (
    <div className="consulting">
      <div
        className="div-2"
        style={{
          height: screenWidth < 1440 ? "7740px" : screenWidth >= 1440 ? "4878px" : undefined,
      ...
      >
        ...
        <div
          className="overlap"
          style={{
            height: screenWidth < 1440 ? "442px" : screenWidth >= 1440 ? "2667px" : undefined,
            left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "-27px" : undefined,
            top: screenWidth < 1440 ? "60px" : screenWidth >= 1440 ? "-5px" : undefined,
            width: screenWidth < 1440 ? "390px" : screenWidth >= 1440 ? "1479px" : undefined,
          }}
        >
          {screenWidth >= 1440 && (
            <>
          ...
          <div
            ...
            style={{
              height: screenWidth < 1440 ? "442px" : screenWidth >= 1440 ? "671px" : undefined,
              left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "47px" : undefined,
              top: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "1971px" : undefined,
              width: screenWidth < 1440 ? "390px" : screenWidth >= 1440 ? "1379px" : undefined,
            }}
          >
            <div
              className="overlap-2"
              style={{
                height: screenWidth < 1440 ? "674px" : screenWidth >= 1440 ? "590px" : undefined,
                left: screenWidth >= 1440 ? "-66px" : undefined,
                top: screenWidth >= 1440 ? "99px" : undefined,
                width: screenWidth < 1440 ? "1456px" : screenWidth >= 1440 ? "1432px" : undefined,
              }}
            >
              {screenWidth < 1440 && (
                <>
          ...
          {screenWidth < 1440 && <div className="rectangle-10" />}
        </div>
        {screenWidth >= 1440 && (
          <>
                ...
                <div className="overlap-group-9">
                  ...
                  <div className="frame-76">
                    ...
                    <div className="frame-46">
                      ...
                      <img className="amazon-2" alt="Amazon" src="/consulting/amazon-1-1.png" />
