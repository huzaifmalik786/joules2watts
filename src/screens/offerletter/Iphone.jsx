  ...
  return (
    <div className="offerletter">
      <div
        className="div-2"
        style={{
          backgroundColor: screenWidth < 1440 ? "#ffffff" : screenWidth >= 1440 ? "var(--neutral-0)" : undefined,
          height: screenWidth < 1440 ? "6171px" : screenWidth >= 1440 ? "5228px" : undefined,
      ...
      >
        ...
        <div
          className="overlap-3"
          style={{
            height: screenWidth >= 1440 ? "2411px" : screenWidth < 1440 ? "1050px" : undefined,
            left: screenWidth >= 1440 ? "-2px" : screenWidth < 1440 ? "-185px" : undefined,
            top: screenWidth >= 1440 ? "1014px" : screenWidth < 1440 ? "4261px" : undefined,
            width: screenWidth >= 1440 ? "1445px" : screenWidth < 1440 ? "742px" : undefined,
          }}
        >
          <div
            className="div-wrapper"
            style={{
              height: screenWidth < 1440 ? "307px" : screenWidth >= 1440 ? "444px" : undefined,
              left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "2px" : undefined,
              width: screenWidth < 1440 ? "742px" : screenWidth >= 1440 ? "807px" : undefined,
            }}
          >
            <div
              className="overlap-group-4"
              style={{
                height: screenWidth < 1440 ? "307px" : screenWidth >= 1440 ? "398px" : undefined,
                left: screenWidth >= 1440 ? "132px" : undefined,
                top: screenWidth >= 1440 ? "23px" : undefined,
                width: screenWidth >= 1440 ? "675px" : undefined,
              }}
            >
              {screenWidth < 1440 && (
                <>
        ...
        <div
          className="overlap-8"
          style={{
            height: screenWidth >= 1440 ? "350px" : screenWidth < 1440 ? "1144px" : undefined,
            left: screenWidth >= 1440 ? "-6px" : screenWidth < 1440 ? "-2px" : undefined,
            top: screenWidth >= 1440 ? "4206px" : screenWidth < 1440 ? "1145px" : undefined,
            width: screenWidth >= 1440 ? "1446px" : screenWidth < 1440 ? "392px" : undefined,
          }}
        >
          {screenWidth >= 1440 && (
