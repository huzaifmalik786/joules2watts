  ...
  return (
    <div className="contact">
      <div
        className="iphone"
        style={{
          height: screenWidth < 1440 ? "4446px" : screenWidth >= 1440 ? "3783px" : undefined,
      ...
      >
          ...
          <>
            ...
            <div className="frame-7">
              ...
              <div className="frame-9">
                ...
                <input className="input" />
                <div className="please-describe-your-wrapper">
                  <input className="please-describe-your" />
                </div>
        ...
        <div
          ...
          style={{
            height: screenWidth >= 1440 ? "540px" : screenWidth < 1440 ? "627px" : undefined,
            left: screenWidth >= 1440 ? "-15px" : screenWidth < 1440 ? "-1px" : undefined,
            top: screenWidth >= 1440 ? "1244px" : screenWidth < 1440 ? "1445px" : undefined,
            width: screenWidth >= 1440 ? "1440px" : screenWidth < 1440 ? "391px" : undefined,
          }}
        >
          {screenWidth >= 1440 && (
          ...
          style={{
            backgroundImage:
              screenWidth >= 1440
                ...
                : undefined,
            height: screenWidth >= 1440 ? "644px" : screenWidth < 1440 ? "173px" : undefined,
            left: screenWidth >= 1440 ? "82px" : screenWidth < 1440 ? "-3123px" : undefined,
            top: screenWidth >= 1440 ? "2552px" : screenWidth < 1440 ? "-8388px" : undefined,
            width: screenWidth >= 1440 ? "1280px" : screenWidth < 1440 ? "344px" : undefined,
          }}
        >
          <div
            className="frame-35"
            style={{
              ...
              height: screenWidth >= 1440 ? "214px" : screenWidth < 1440 ? "57px" : undefined,
              left: screenWidth >= 1440 ? "32px" : screenWidth < 1440 ? "9px" : undefined,
              top: screenWidth >= 1440 ? "32px" : screenWidth < 1440 ? "9px" : undefined,
              width: screenWidth < 1440 ? "104px" : undefined,
            }}
          >
            <div
              className="frame-36"
              style={{
                marginBottom: screenWidth < 1440 ? "-135.51px" : undefined,
                marginRight: screenWidth < 1440 ? "-283.77px" : undefined,
              }}
            >
              <img
                className="direction"
                style={{
                  left: screenWidth >= 1440 ? "305px" : screenWidth < 1440 ? "-3951px" : undefined,
                  top: screenWidth >= 1440 ? "0" : screenWidth < 1440 ? "-14467px" : undefined,
                }}
                alt="Direction"
                src={
                  screenWidth >= 1440
