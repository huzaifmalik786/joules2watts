    ...
    <div className="industries">
      ...
      >
        ...
        <div
          className="overlap"
          style={{
            height: screenWidth >= 1440 ? "631px" : screenWidth < 1440 ? "876px" : undefined,
            left: screenWidth >= 1440 ? "-5px" : screenWidth < 1440 ? "-10px" : undefined,
            top: screenWidth >= 1440 ? "0" : screenWidth < 1440 ? "60px" : undefined,
            width: screenWidth >= 1440 ? "1447px" : screenWidth < 1440 ? "574px" : undefined,
          }}
        >
          {screenWidth >= 1440 && (
            <div className="frame">
          ...
          <img
            className="image"
            style={{
              height: screenWidth >= 1440 ? "162px" : screenWidth < 1440 ? "457px" : undefined,
              left: screenWidth >= 1440 ? "5px" : screenWidth < 1440 ? "10px" : undefined,
              top: screenWidth >= 1440 ? "89px" : screenWidth < 1440 ? "186px" : undefined,
              width: screenWidth >= 1440 ? "1440px" : screenWidth < 1440 ? "390px" : undefined,
            }}
            alt="Image"
            src={screenWidth >= 1440 ? "/industries/image-1-1.svg" : screenWidth < 1440 ? "/industries/hud-ball-1.gif" : undefined}
          />
          {screenWidth < 1440 && (
        ...
        <div
          className="overlap-3"
          style={{
            height: screenWidth < 1440 ? "1404px" : screenWidth >= 1440 ? "2216px" : undefined,
            left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "-4px" : undefined,
            top: screenWidth < 1440 ? "2736px" : screenWidth >= 1440 ? "1804px" : undefined,
            width: screenWidth < 1440 ? "390px" : screenWidth >= 1440 ? "1578px" : undefined,
          }}
        >
          ...
          <div
            ...
            style={{
              height: screenWidth < 1440 ? "587px" : screenWidth >= 1440 ? "552px" : undefined,
              left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "6px" : undefined,
              top: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "1305px" : undefined,
              width: screenWidth < 1440 ? "390px" : screenWidth >= 1440 ? "1443px" : undefined,
            }}
          />
          {screenWidth < 1440 && (
            <>
        ...
        <div
          ...
          style={{
            height: screenWidth < 1440 ? "810px" : screenWidth >= 1440 ? "453px" : undefined,
            left: screenWidth < 1440 ? "0" : screenWidth >= 1440 ? "79px" : undefined,
            top: screenWidth < 1440 ? "1483px" : screenWidth >= 1440 ? "662px" : undefined,
            width: screenWidth < 1440 ? "394px" : screenWidth >= 1440 ? "1237px" : undefined,
          }}
        >
          {screenWidth < 1440 && (
            <>
