...
export const Carousel = ({ className, arrowForwardClassName, arrowForward = "/consulting/arrow-forward-55.svg" }) => {
  return (
    <div className={`carousel ${className}`}>
      <div className="overlap-group">
        <img className="rectangle" alt="Rectangle" src="/consulting/rectangle-26-2.webp" />
        <div className="div" />
        <div className="frame">
