...
export const CarouselWrapper = ({ className, arrowForwardClassName, arrowForward = "/administrative/arrow-forward-55.svg" }) => {
  return (
        ...
        <div className="frame-4">
          ...
          <div className="frame-5">
            ...
            <button className="CTA-2">
              ...
              <img className={`arrow-forward-3 ${arrowForwardClassName}`} alt="Arrow forward" src={arrowForward} />
            </button>
          </div>
        </div>
        <div className="text-wrapper-6">Why work with us?</div>
