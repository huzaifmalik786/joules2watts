...
export const Carousel = ({ className, arrowForwardClassName, arrowForward = "/rpo/arrow-forward-55.svg" }) => {
  return (
    <div className={`carousel ${className}`}>
      <div className="overlap-group">
        <img className="rectangle" alt="Rectangle" src="/rpo/rectangle-26-2.webp" />
        <div className="div" />
        <div className="frame">
