...
export const Carousel = ({ className, arrowForwardClassName, arrowForward = "/homepage/arrow-forward-8.svg" }) => {
  return (
    <div className={`carousel ${className}`}>
      <div className="overlap-group">
        <img className="img" alt="Rectangle" src="/homepage/rectangle-26-1.png" />
